...
<html lang="en">
		...
		.load(
				function() {
					$
							.ajax({
								type : "GET",
								url : "http://localhost:9090/storebackend/rest/modules",
  ...
  <body>
    ...
    <script src="${pageContext.request.contextPath}/resources/js/morris/chart-data-morris.js"></script>
    <script src="${pageContext.request.contextPath}/resources/js/tablesorter/jquery.tablesorter.js"></script>
    <script src="${pageContext.request.contextPath}/resources/js/tablesorter/tables.js"></script>
